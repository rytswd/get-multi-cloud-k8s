...
locals {
  ...
  aws_iam_member = "arn:aws:iam::${data.terraform_remote_state.init.outputs.aws_account_iam_id}:role/Member"
  aws_v01_member = "arn:aws:iam::${data.terraform_remote_state.init.outputs.aws_v01_account_id}:role/Member"
}
